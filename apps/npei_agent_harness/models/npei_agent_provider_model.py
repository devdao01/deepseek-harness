...
class NpeiAgentProviderModel(models.Model):
    ...
    def _push_models(self, providers):
        ...
        for provider in providers:
            ...
            # settings/mutate is revision-guarded: read the namespace's current
            # revision right before the write so a concurrent editor is refused
            # by the harness instead of silently overwritten.
