...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('forbidden'), message: z.string(), details: z.object({ sessionId: z.string().optional() }) }),
  ...
  z.object({ code: z.literal('skill-invalid-name'), message: z.string(), details: z.object({ name: z.string() }) }),
  z.object({ code: z.literal('skill-not-found'), message: z.string(), details: z.object({ name: z.string() }) }),
  z.object({ code: z.literal('skill-too-large'), message: z.string(), details: z.object({ name: z.string() }) }),
