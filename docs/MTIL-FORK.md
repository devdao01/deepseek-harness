...
|---|---|---|---|
| Workspace file transfer | `packages/api/session-controller/src/{index,commands,types}.ts` | `session/readWorkspaceFile` (browser download, traversal-refusing, 100 MiB cap) and `session/uploadWorkspaceFile` (uploads/ dir, base-name-only, collision suffix) | `2537206a`, `3a97eb98` |
